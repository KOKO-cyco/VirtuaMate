 ...
 */
#ifndef VRM_OVERLAY_H
#define VRM_OVERLAY_H
...
typedef void (*vrm_overlay_str_cb_t)(const char *value, void *user_data);
typedef void (*vrm_overlay_int_cb_t)(int value, void *user_data);
...
typedef struct {
    ...
    int                    fullscreen;
    int                    spectator;
    vrm_overlay_str_cb_t   on_model_change;
    vrm_overlay_int_cb_t   on_anim_change;
    vrm_overlay_str_cb_t   on_scene_change;
    vrm_overlay_int_cb_t   on_camera_lock;
    vrm_overlay_int_cb_t   on_subtitle;
    vrm_overlay_int_cb_t   on_fullscreen;
    vrm_overlay_int_cb_t   on_spectator;
    void                  *user_data;
} vrm_overlay_cfg_t;
